...
var channel = {
      id: ObjectId('624e496f93693c3e2cfbc8ab'),
      youtubeId:'UC9yCvz0M2Fzcn6d3gb0v2dA',
...
function getPlayer1CharacterId(title){
  var start = title.indexOf('Ranked') + 7;
...
function getCharacterIdByName(name) {
  var character = characterList.filter(c => c.GameId === mongoGameId && c.Name.includes(name))[0];
  if(character){
